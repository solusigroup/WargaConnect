                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.expenses.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="judul" class="block mt-1 w-full" type="text" name="judul" :value="old('judul')" required autofocus placeholder="Contoh: Perbaikan Gapura" />
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="3" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="nominal" class="block mt-1 w-full" type="number" name="nominal" :value="old('nominal')" required placeholder="Example: 150000" min="0" />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_pengeluaran" class="block mt-1 w-full" type="date" name="tanggal_pengeluaran" :value="old('tanggal_pengeluaran', date('Y-m-d'))" required />
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400" id="file_help">Max 2MB (JPG, PNG).</p>
